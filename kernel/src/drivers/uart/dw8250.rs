...
use crate::{mm::PhysAddr, sync::Mutex};
...
const UART_PADDR: usize = 0xdeadbeef; // Placeholder address, replace with actual physical address
const UART_BASE: PhysAddr = PhysAddr::new(UART_PADDR);

pub static UART: Mutex<DW8250> =
    Mutex::new(DW8250::new(UART_BASE.into_kvaddr().as_usize()));
